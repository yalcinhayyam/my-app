export const NavBar = () => {
    return <nav className="flex container mx-auto border-b justify-between px-5 py-10 items-center bg-white">
        <h1 className="text-xl text-gray-800 font-medium">HotCoffee</h1>
